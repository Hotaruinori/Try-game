package com.hotaruinori.monsters.BABY;
...
public class BabyC {
    ...
    public void update(float deltaTime) {
        ...
        // 並且只有在非自爆狀態下才觸發自爆
        if (BabyC_Rectangle().overlaps(character.getCharacterRectangle()) && !hasExplodedDamageDealt) {
            // 觸發自爆
    ...
    // Boss 的碰撞矩形
    public Rectangle BabyC_Rectangle() {
